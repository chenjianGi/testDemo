	        	...
	        	Throwable throwable = tr.getThrowable();
	                ...
	                for(Error e:Assertion.errors){
	                        ...
	                        StackTraceElement[] message = new StackTraceElement[]{
	                                    new StackTraceElement("message:"+e.getMessage()+" in method:",tr.getMethod().getMethodName(),tr.getTestClass().getRealClass().getSimpleName(),index)
	                            };
	                        index = 0;
	                ...
	                //如果本test是在抛出错误的情况下进入onTestFailure()方法进入监听程序，那么traces就不为空
	                //追加错误信息在Assert错误后
	                if(traces!=null){
